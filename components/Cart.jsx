  ...
  return (
    ...
    <div className='cart-wrapper' ref={cartRef} >
      <div className='cart-container'>
        <button type='button' className='cart-heading' onClick={() => setShowCart(prev => !prev)} >
          <AiOutlineLeft />
        ...
        {cartItems.length < 1 && (
          <div className='empty-cart' >
            <img src="https://phanox.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fshopping-bag.a3abe833.webp&w=256&q=75" alt='empty-ag-pic' width="300px" height="300px" />
        ...
        <div className='product-container'>
          {cartItems.length >= 1 && cartItems.map((item) => (
            <div className='product' key={item._id}>
              <img src={urlFor(item?.image[0])} alt="fix-this" className='cart-product-image' />
